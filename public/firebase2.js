...
//Todolist data 저장
document.getElementById("enter_Button").addEventListener('click', () => {
    db.collection('TodoList').add({Date: today, checkbox_text1: $('#checkbox_text1').val(), checkbox_text2: $('#checkbox_text2').val(), checkbox_text3: $('#checkbox_text3').val()})
  });

//저장된 data 가져오기
// var get_seed_data= db.collection('TodoList').where("Date", "==", today)
//     .get()
//     .then((result)=>{
//         //console.log(result);
//         result.forEach((doc)=>{
